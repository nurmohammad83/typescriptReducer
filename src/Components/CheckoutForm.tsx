...
const CheckoutFrom = () => {
    const reducer = (state:IInitialState,action:AppAction)=>{
        switch (action.type) {
            case "INPUT":
                return {
                    ...state,
  ...
  return (
    ...
    <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
      <section
        className="relative flex h-32 items-center justify-center bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6"
      >
          <div className="text-white text-center space-y-2">
            <h2 className="text-2xl font-semibold text-orange-400">Welcome {`${state.first_name} ${state.last_name}`}</h2>
